define(['dart_sdk', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data', 'packages/intl/date_symbols'], function(dart_sdk, plural_rules, number_symbols, number_symbols_data, date_symbols) {
  ...
  const src__intl_helpers = Object.create(dart.library);
  const intl = Object.create(dart.library);
  const src__date_format_internal = Object.create(dart.library);
  ...
  const _badMessages = dart.privateName(src__intl_helpers, "_badMessages");
  const _throwException = dart.privateName(src__intl_helpers, "_throwException");
  const _uninitializedMessages = dart.privateName(src__intl_helpers, "_uninitializedMessages");
  const _reportErrors = dart.privateName(src__intl_helpers, "_reportErrors");
  ...
  intl.Intl = class Intl extends core.Object {
    static get defaultLocale() {
      let zoneLocale = async.Zone.current._get(const$ || (const$ = dart.const(new _internal.Symbol.new('Intl.locale'))));
    ...
    static message(message_str, opts) {
      ...
      let examples = opts && 'examples' in opts ? opts.examples : const$0 || (const$0 = dart.constMap(core.String, core.Object, []));
    ...
    static _plural(howMany, opts) {
      ...
      return core.String._check((t0 = translated, t0 == null ? intl.Intl.pluralLogic(howMany, {zero: zero, one: one, two: two, few: few, many: many, other: other, locale: locale}) : t0));
    }
    ...
    static withLocale(locale, func) {
      ...
      return async.runZoned(dart.dynamic, func, {zoneValues: new _js_helper.LinkedMap.from([const$1 || (const$1 = dart.const(new _internal.Symbol.new('Intl.locale'))), canonical])});
    }
  ...
  intl.BidiFormatter = class BidiFormatter extends core.Object {
    ...
    wrapWithUnicode(text, opts) {
      ...
      if (dart.test(this.contextDirection.isDirectionChange(direction))) {
        ...
        result = dart.str(marker) + dart.str(text) + dart.str(intl.Bidi.PDF);
      }
  ...
  intl.Bidi = class Bidi extends core.Object {
    ...
    static enforceRtlInText(text) {
      return dart.str(intl.Bidi.RLE) + dart.str(text) + dart.str(intl.Bidi.PDF);
    }
    static enforceLtrInHtml(html) {
      return intl.Bidi._enforceInHtmlHelper(html, "ltr");
    }
    static enforceLtrInText(text) {
      return dart.str(intl.Bidi.LRE) + dart.str(text) + dart.str(intl.Bidi.PDF);
    }
    ...
    static guardBracketInText(str, isRtlContext) {
      if (isRtlContext === void 0) isRtlContext = null;
      let useRtl = isRtlContext == null ? intl.Bidi.hasAnyRtl(str) : isRtlContext;
      let mark = dart.test(useRtl) ? intl.Bidi.RLM : intl.Bidi.LRM;
  ...
  intl._CompactFormatType.COMPACT_DECIMAL_SHORT_PATTERN = dart.const(new intl._CompactFormatType.new(0, "_CompactFormatType.COMPACT_DECIMAL_SHORT_PATTERN"));
  intl._CompactFormatType.COMPACT_DECIMAL_LONG_PATTERN = dart.const(new intl._CompactFormatType.new(1, "_CompactFormatType.COMPACT_DECIMAL_LONG_PATTERN"));
  intl._CompactFormatType.COMPACT_DECIMAL_SHORT_CURRENCY_PATTERN = dart.const(new intl._CompactFormatType.new(2, "_CompactFormatType.COMPACT_DECIMAL_SHORT_CURRENCY_PATTERN"));
  ...
  intl.NumberFormat = class NumberFormat extends core.Object {
    ...
    [_formatFractionPart](fractionPart) {
      ...
      while (fractionPart[$codeUnitAt](fractionLength - 1) === intl.NumberFormat._zero && fractionLength > dart.notNull(this.minimumFractionDigits) + 1) {
  ...
  (intl.NumberFormat._forPattern = function(locale, getPattern, opts) {
    ...
    this[_zeroOffset] = dart.notNull(this[_localeZero]) - dart.notNull(intl.NumberFormat._zero);
  ...
  intl.DateFormat = class DateFormat extends core.Object {
    ...
    get [_availableSkeletons]() {
      return core.Map._check(dart.dsend(src__date_format_internal.dateTimePatterns, '_get', [this.locale]));
    }
    get dateSymbols() {
      if (this[_locale] != src__date_format_internal.lastDateSymbolLocale) {
        ...
        src__date_format_internal.cachedDateSymbols = date_symbols$.DateSymbols._check(dart.dsend(src__date_format_internal.dateTimeSymbols, '_get', [this[_locale]]));
      }
  ...
  intl._NumberFormatParser = class _NumberFormatParser extends core.Object {
    ...
    parseCharacterAffix(affix) {
      ...
      if (ch == intl._NumberFormatParser._QUOTE) {
        if (this.pattern.peek == intl._NumberFormatParser._QUOTE) {
          this.pattern.moveNext();
          affix.write(intl._NumberFormatParser._QUOTE);
        } else {
      ...
      if (dart.test(this.inQuote)) {
        ...
        switch (ch) {
          case intl._NumberFormatParser._PATTERN_DIGIT:
          case intl._NumberFormatParser._PATTERN_ZERO_DIGIT:
          case intl._NumberFormatParser._PATTERN_GROUPING_SEPARATOR:
          case intl._NumberFormatParser._PATTERN_DECIMAL_SEPARATOR:
          case intl._NumberFormatParser._PATTERN_SEPARATOR:
          {
            return false;
          }
          case intl._NumberFormatParser._PATTERN_CURRENCY_SIGN:
          {
            affix.write(this.currencySymbol);
            break;
          }
          case intl._NumberFormatParser._PATTERN_PERCENT:
          {
            if (this.format[_multiplier] !== 1 && this.format[_multiplier] != intl._NumberFormatParser._PERCENT_SCALE) {
              dart.throw(new core.FormatException.new("Too many percent/permill"));
            }
            this.format[_multiplier] = intl._NumberFormatParser._PERCENT_SCALE;
            affix.write(this.symbols.PERCENT);
            break;
          }
          case intl._NumberFormatParser._PATTERN_PER_MILLE:
          {
            if (this.format[_multiplier] !== 1 && this.format[_multiplier] != intl._NumberFormatParser._PER_MILLE_SCALE) {
              dart.throw(new core.FormatException.new("Too many percent/permill"));
            }
            this.format[_multiplier] = intl._NumberFormatParser._PER_MILLE_SCALE;
    ...
    parseTrunkCharacter(trunk) {
      ...
      switch (ch) {
        ...
        case intl._NumberFormatParser._PATTERN_EXPONENT:
        {
          ...
          if (nextChar == intl._NumberFormatParser._PATTERN_PLUS) {
            dart.dsend(trunk, 'write', [this.pattern.current]);
            this.pattern.moveNext();
            this.format[_useSignForPositiveExponent] = true;
          }
          while (this.pattern.current == intl._NumberFormatParser._PATTERN_ZERO_DIGIT) {
            dart.dsend(trunk, 'write', [this.pattern.current]);
            this.pattern.moveNext();
            t7 = this.format;
  ...
  intl._MicroMoney = class _MicroMoney extends core.Object {
    get [_integerPart]() {
      return dart.dsend(this[_micros$], '~/', [intl._MicroMoney._multiplier]);
    }
    get [_fractionPart]() {
    ...
    ['-'](other) {
      ...
      return new intl._MicroMoney.new(dart.dsend(this[_micros$], '-', [dart.dsend(other, '*', [intl._MicroMoney._multiplier])]));
    }
    ['+'](other) {
      if (intl._MicroMoney.is(other)) return new intl._MicroMoney.new(dart.dsend(this[_micros$], '+', [other[_micros$]]));
      return new intl._MicroMoney.new(dart.dsend(this[_micros$], '+', [dart.dsend(other, '*', [intl._MicroMoney._multiplier])]));
    ...
    ['~/'](divisor) {
      ...
      return new intl._MicroMoney.new(dart.dsend(dart.dsend(this[_integerPart], '~/', [divisor]), '*', [intl._MicroMoney._multiplier]));
    }
    ['*'](other) {
      if (!core.int.is(other)) {
        dart.throw(new core.ArgumentError.value(other, "other", "_MicroMoney * only supports int arguments."));
      }
      return new intl._MicroMoney.new(dart.dsend(dart.dsend(dart.dsend(this[_integerPart], '*', [other]), '*', [intl._MicroMoney._multiplier]), '+', [dart.notNull(this[_fractionPart]) * dart.notNull(core.num._check(other))]));
    }
    remainder(other) {
      if (!core.int.is(other)) {
        dart.throw(new core.ArgumentError.value(other, "other", "_MicroMoney.remainder only supports int arguments."));
      }
      return new intl._MicroMoney.new(dart.dsend(this[_micros$], 'remainder', [dart.dsend(other, '*', [intl._MicroMoney._multiplier])]));
    }
    toDouble() {
      return core.double._check(dart.dsend(dart.dsend(this[_micros$], 'toDouble', []), '/', [intl._MicroMoney._multiplier]));
    }
    toInt() {
